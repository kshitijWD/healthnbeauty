        ...
        <div class="container">
            <div class="row">
                            ...
                            <div class="featured-content-inner">
                                <div class="post-header">
                                    ...
                                    <div class="post-title featured-title">
                                        <h3><a href="blog-single.php">Here’s the top promising shopify template
                                                of – 2023</a></h3>
                                    </div>
                                </div>
                        ...
                        <div class="featured-content">
                            <div class="featured-content-inner">
                                <div class="post-header">
                                    ...
                                    <div class="post-title featured-title">
                                        <h3><a href="blog-single.php">Best lawyer services HTML template listed
                        ...
                        <div class="featured-content">
                            <div class="featured-content-inner">
                                <div class="post-header">
                                    ...
                                    <div class="post-title featured-title">
                                        <h3><a href="blog-single.php">Get the best opencart template for the
                                                medical</a></h3>
                                    </div>
                                </div>
                            </div><!-- featured-content end -->
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    ...
                    <div class="featured-imagebox featured-imagebox-post style1">
                        <div class="featured-thumbnail">
                            <img width="303" height="300" class="img-fluid" src="images/blog/blog-04.jpg" alt="">
                        </div>
                        <!-- featured-content -->
                        <div class="featured-content">
                            <div class="featured-content-inner">
                                <div class="post-header">
                                    ...
                                    <div class="post-title featured-title">
                                        <h3><a href="blog-single.php">5 trendy template for architecture &
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    ...
                    <div class="featured-imagebox featured-imagebox-post style1">
                        <div class="featured-thumbnail">
                            <img width="303" height="300" class="img-fluid" src="images/blog/blog-05.jpg" alt="">
                        </div>
                        <!-- featured-content -->
                        <div class="featured-content">
                            <div class="featured-content-inner">
                                <div class="post-header">
                                    ...
                                    <div class="post-title featured-title">
                                        <h3><a href="blog-single.php">Get the best templates for ayurvedic
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    ...
                    <div class="featured-imagebox featured-imagebox-post style1">
                        <div class="featured-thumbnail">
                            <img width="303" height="300" class="img-fluid" src="images/blog/blog-06.jpg" alt="">
                        </div>
                        <!-- featured-content -->
                        <div class="featured-content">
                            <div class="featured-content-inner">
                                <div class="post-header">
                                    ...
                                    <div class="post-title featured-title">
                                        <h3><a href="blog-single.php">Unique templates for fitness & food
                                                category</a></h3>
                                    </div>
                                </div>
                            </div><!-- featured-content end -->
