                    ...
                    <div class="row">
                        <div class="col-xl-10 col-lg-12 position-relative m-auto">
                            ...
                            <div class="hero-overlay-box">
                                ...
                                <div>
                                    <h3>Vaterian hospital services manufacture In 1996</h3>
                                </div>
                            </div>
                        </div>
                    </div>
...
<div class="site-main">
    <!-- product-section -->
    <section class="product-section animation clearfix">
        <div class="container">
            ...
            <div class="row">
                <div class="col-12">
                    <h2 class="title text-center my-5">Ayurvedic Diseases & Conditions We Treat</h4>
                </div>
            </div>
        </div>
    </section>
    <section class="prt-row padding_zero-section bg-base-grey brd-bottom clearfix">
        <div class="container-fluid">
            <!--row-->
            <div class="row row-equal-height slick_slider fadeup-amin" data-slick='{"slidesToShow": 5,
                                                                                    "slidesToScroll": 1,
                                                                                    "arrows":false,
                                                                                    "dots":false,
                                                                                    "autoplay":true,
                    ...
                    <div class="featured-icon-box icon-align-before-content icon-ver_align-top style1">
                        <div class="featured-icon">
                            <div class="prt-icon prt-icon_element-onlytxt prt-icon_element-color-darkcolor prt-icon_element-style-rounded prt-icon_element-size-md">
                                <img class="img-fluid" src="images/icons/1.png" alt="img">
                            </div>
                        </div>
                        <div class="featured-content">
                            <div class="featured-title">
                ...
                <div class="col">
                    ...
                    <div class="featured-icon-box icon-align-before-content icon-ver_align-top style1">
                        <div class="featured-icon">
                            <div class="prt-icon prt-icon_element-onlytxt prt-icon_element-color-darkcolor prt-icon_element-style-rounded prt-icon_element-size-md">
                                <img class="img-fluid" src="images/icons/3.png" alt="img">
                            </div>
                        </div>
                        <div class="featured-content">
                            <div class="featured-title">
                ...
                <div class="col">
                    ...
                    <div class="featured-icon-box icon-align-before-content icon-ver_align-top style1">
                        <div class="featured-icon">
                            <div class="prt-icon prt-icon_element-onlytxt prt-icon_element-color-darkcolor prt-icon_element-style-rounded prt-icon_element-size-md">
                                <img class="img-fluid" src="images/icons/4.png" alt="img">
                            </div>
                        </div>
                        <div class="featured-content">
                            <div class="featured-title">
                ...
                <div class="col">
                    ...
                    <div class="featured-icon-box icon-align-before-content icon-ver_align-top style1">
                        <div class="featured-icon">
                            <div class="prt-icon prt-icon_element-onlytxt prt-icon_element-color-darkcolor prt-icon_element-style-rounded prt-icon_element-size-md">
                                <img class="img-fluid" src="images/icons/5.png" alt="img">
                            </div>
                        </div>
                        <div class="featured-content">
                            <div class="featured-title">
                                <h3>Seamless cares</h3>
                            </div>
                        </div>
                    </div><!--featured-icon-box end-->
                </div>
                <div class="col">
                    ...
                    <div class="featured-icon-box icon-align-before-content icon-ver_align-top style1">
                        <div class="featured-icon">
                            <div class="prt-icon prt-icon_element-onlytxt prt-icon_element-color-darkcolor prt-icon_element-style-rounded prt-icon_element-size-md">
                                <img class="img-fluid" src="images/icons/6.png" alt="img">
                            </div>
                        </div>
                        <div class="featured-content">
                            <div class="featured-title">
            ...
            <div class="row">
                    ...
                    <div class="pr-20 res-1199-pr-0">
                        ...
                        <div class="section-title">
                            ...
                            <div class="title-desc">
                                <p class="prt-about-desc">We enables true delivery of Ayurveda with personalised treatment for each individual at all touch-points. We are the first and biggest Ayurveda organisation to have championed a protocol and data-driven diagnosis and treatment.</p>
                            </div>
                        </div>
                        <!-- section title end-->
                ...
                <div class="col-lg-6">
                    <div class="pl-20 res-1199-pl-0 res-991-mt-30">
                        ...
                        <div class="section-title">
                            <div class="title-desc">
                                <p> Our scientific spirit is grounded in rational principles, ensuring personalised treatment for each patient, to help them regain “Swasthya” with the use of “Chikitsa” and lifestyle changes.</p>
                            </div>
                        </div>
                        <!-- section title end-->
                        <div class="row g-0">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <ul class="prt-list prt-list-style-icon-01">
                                    ...
                                    <li class="prt-list-li-content">Cause Based Treatment</li>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    ...
                    <div class="featured-imagebox featured-imagebox-post style1">
                        <div class="featured-thumbnail">
                            <img width="303" height="300" class="img-fluid" src="images/blog/blog-02.jpg" alt="">
                        </div>
                        <!-- featured-content -->
                        <div class="featured-content">
                            <div class="featured-content-inner">
                                <div class="post-header">
                                    ...
                                    <div class="post-title featured-title">
                                        <h3><a href="blog-single.html">Best lawyer services HTML template listed
                                                as multilingual</a></h3>
                                    </div>
                                </div>
                            </div><!-- featured-content end -->
                        </div>
